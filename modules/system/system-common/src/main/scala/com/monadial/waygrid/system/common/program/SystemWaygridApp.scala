...
object SystemWaygridApp:
   ...
   */
  inline def Billing: NodeDescriptor = NodeDescriptor.System(NodeService("billing"))
   ...
   */
  inline def DagRegistry: NodeDescriptor = NodeDescriptor.System(NodeService("dag-registry"))
   ...
   */
  inline def History: NodeDescriptor = NodeDescriptor.System(NodeService("history"))
   ...
   */
  inline def IAM: NodeDescriptor = NodeDescriptor.System(NodeService("iam"))
   ...
   */
  inline def KMS: NodeDescriptor = NodeDescriptor.System(NodeService("kms"))
   ...
   */
  inline def Scheduler: NodeDescriptor = NodeDescriptor.System(NodeService("scheduler"))
   ...
   */
  inline def SecureStore: NodeDescriptor = NodeDescriptor.System(NodeService("secure-store"))
   ...
   */
  inline def Topology: NodeDescriptor = NodeDescriptor.System(NodeService("topology"))
   ...
   */
  inline def Waystation: NodeDescriptor = NodeDescriptor.System(NodeService("waystation"))
