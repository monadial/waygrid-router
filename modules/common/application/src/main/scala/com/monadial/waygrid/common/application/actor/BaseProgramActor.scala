...
abstract class BaseProgramActor[F[+_]: {Async, Parallel, Logger}, N <: NodeSettings](
  protected val settings: NodeSettings
) extends SupervisedActor[F, ProgramSupervisorRequest]:
